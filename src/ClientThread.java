...
public class ClientThread extends Thread {
    ...
    public void run() {
        try {
                ...
                String line;
                StringBuilder httpHeader = new StringBuilder(); //stores the html header
    ...
    public void processRequest(String htmlFile) throws IOException {
        ...
        if(file.exists()) {
            ...
            out.print("Date: " + new Date() + CRLF);
            out.print("Server: Sultan Server" + CRLF);
        ...
        //file does not exist
            ...
            out.print("Server: Sultx Server" + CRLF);
